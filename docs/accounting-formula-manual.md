...
> **版本**：`v1.3`（2026-07-15）
> **程式碼基線**：`v0.1.18 + feat/fee-engine-v2`
...
| --- | --- | ---: | ---: | --- |
| NVDA 買 30@500 | 4.50+0.99+0.09+0.00 | **5.58** | ⌈64,500/1000⌉=65 → 65/4.3=**15.12** | `fee_engine.fee/tax moomoo_my_us/NVDA buy 30@500` |
| NVDA 賣 25@600 | 4.50+0.99+0.08+0.00+SEC0.31+TAF0.01 | **5.89** | 65/4.3=**15.12** | `fee_engine.fee/tax moomoo_my_us/NVDA sell 25@600` |
| 買 1,000@0.10（**交收 cap**） | 0.03+0.99+min(3.00,1.00)+0.00 | **2.02** | — | 單元 `test_moomoo_us_settlement_cap` |

### 3.4 MY（`moomoo_my_my` → 規則集 `moomoo_my`，`market = MY`，native MYR）
...
| --- | --- | ---: | ---: | --- |
| 1155 買 1,000@9.50 | 2.85+3.00+2.85+0.70 | **9.40** | ⌈9,500/1000⌉=10 → **10.00** | `fee_engine.fee/tax moomoo_my_my/1155 buy 1000@9.50` |
| 1155 賣 400@11.00 | 1.32+3.00+1.32+0.45 | **6.09** | ⌈4,400/1000⌉=5 → **5.00** | `fee_engine.fee/tax moomoo_my_my/1155 sell 400@11.00` |
| **0800EA 買 1,000@1.15（ETF）** | 0.35+3.00+0.35+0.30 | **4.00** | **0.00（ETF 免徵）** | `fee_engine.fee/tax moomoo_my_my/0800EA buy 1000@1.15 [etf]` |

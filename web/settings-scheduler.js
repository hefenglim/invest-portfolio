...
(function () {
  ...
  const JOB_ZH = {
    ...
    fundamentals_daily: '基本面快照（yfinance＋Finnhub 聯集）',
    fundamentals_av_weekly: '基本面快照（Alpha Vantage・週六・僅持有）',
    signal_scan: '技術訊號掃描',
    news_daily: '新聞摘要',
  ...
  const JOB_HREF = {
    ...
    fundamentals_daily: 'settings.html#datasources',
    fundamentals_av_weekly: 'settings.html#datasources',
